...
const SearchBar = ({ setIPAddress,fetchLocation }) => {
  ...
  return (
    <div className="h-2/5 min-w-full search-bar-container bg-cover flex flex-col gap-5 items-center sm:justify-center">
        <h2 className="text-white font-bold items-center mt-5 sm:mt-0">
            IP Address Tracker
        </h2>
        <div className="md:w1/2 sm:w1/2 lg:w-1/3 flex justify-center items-center h-10">
            <input type="text"
